...
#print ('take your cash',cashAmount ,'and remaining balance is ', remainingAmount )
print ('take your cash {1}, remaining balance in your account {0}'.format(cashAmount,remainingAmount))
